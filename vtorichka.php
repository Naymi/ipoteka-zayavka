...
<html lang="ru">
   <head>
      ...
      <meta charset="UTF-8">
      <title>Ипотека на готовое жилье по ставке от 10%</title>
    ...
    <!-- /Yandex.Metrika counter -->
      <header>
         <div class="header-wrapper">
            ...
            <div class="text">
               <h1>ипотека на готовое жилье по ставке от 10%</h1>
            </div>
         </div>
      </header>
      <main>
         <div class="forma shade">
            ...
            <form id="main-form" action="javascript:void(null);" onsubmit="call()">
               <input type="hidden" value="Вторичка" name="Тип заявки">
      ...
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script> <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.maskedinput/1.4.1/jquery.maskedinput.min.js"></script> <script src="https://mc.yandex.ru/metrika/watch.js"></script> <script src="../js/main.js"></script> <script>function call() {if(!all_validate()) {$("button").css({"background-color":err_color});return false;} var msg=$('form').serialize();$.ajax({type:'POST',url:'/send.php',data:msg,success:function(data){if(data==1) {yaCounter49678438.reachGoal('ipoteka_na_gotovoe');window.location.replace('http://ipotekazayavka.ru/spasibo.html');}},error:function(xhr,str){}});}</script> 
